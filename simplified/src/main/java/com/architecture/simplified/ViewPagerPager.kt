...
class ViewPagerPager(private val viewPager: ViewPager2, val viewModel: OnBoardingViewModel) {
    private lateinit var imageLearn: ImageView
    ...
    fun advance() {
        ...
        ValueAnimator.ofInt(0, dragDistance).apply {
            ...
            addUpdateListener {
                ...
                if (current == 1)
                    viewModel.buttonText("Get Started")
                else
                    viewModel.buttonText("Next")
    ...
    companion object {
        private const val PAGE_CHANGE_DURATION = 800L
