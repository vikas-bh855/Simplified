...
public abstract class Hilt_LearnLanguagesFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_LearnLanguagesFragment() {
    super();
  }

  Hilt_LearnLanguagesFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((LearnLanguagesFragment_GeneratedInjector) generatedComponent()).injectLearnLanguagesFragment(UnsafeCasts.<LearnLanguagesFragment>unsafeCast(this));
  }
