...
public abstract class Hilt_GetAwardsFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_GetAwardsFragment() {
    super();
  }

  Hilt_GetAwardsFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((GetAwardsFragment_GeneratedInjector) generatedComponent()).injectGetAwardsFragment(UnsafeCasts.<GetAwardsFragment>unsafeCast(this));
  }
