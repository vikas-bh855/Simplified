...
public abstract class Hilt_BuildHabitFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_BuildHabitFragment() {
    super();
  }

  Hilt_BuildHabitFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((BuildHabitFragment_GeneratedInjector) generatedComponent()).injectBuildHabitFragment(UnsafeCasts.<BuildHabitFragment>unsafeCast(this));
  }
